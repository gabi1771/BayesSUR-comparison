...
fit<-BayesSUR(Y=Y,X=X,outFilePath="HRRH",nIter=200000,
...
#MCMC diagnostics
pdf("HRRH.MCMC_diagnostic.pdf")
plot(fit, estimator = "logP", type = "diagnostics")
dev.off()


#Estimators
pdf("HRRH.pdf",width=12,height=4)
...
existing_data <- read_excel("Results_HRRH.xlsx", sheet = "Sheet1")
...
write_xlsx(combined_data, path = "Results_HRRH.xlsx")

# Message de confirmation
cat("Les données ont été ajoutées au fichier Results_HRRH.xlsx")